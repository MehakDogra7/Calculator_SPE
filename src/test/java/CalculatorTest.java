...
public class CalculatorTest {
    ...
    public void addingTruePositive(){
        assertEquals("Adding two integer numbers for True Positive", 2, calculator.root(4), DELTA);
        assertEquals("Adding two double numbers for True Positive", 3, calculator.root(9), DELTA);
    }
